...
namespace BaseCap.CloudAbstractions.Abstractions
{
    ...
    public interface ITableStorage
    {
        ...
        /// <param name="cutOffDate">DateTimeOffset - used to as a mark point in time to delete entities created before that</param>
        /// <param name="cancellationToken">CancellationToken to cancel the async execution</param>
        /// <returns>Task</returns>
        Task DeleteInBatchAsync(
            string tableName,
